...
Install |software| with *pip*::
   ...
   $ sudo pip3 install PyBoolNet-2.2.7_linux64.tar.gz
...
Use the option ``--user`` (literally) if you do not have sudo rights::
   ...
   $ pip3 install PyBoolNet-2.2.7.tar.gz --user
...
To install |software| using *Distutils* unpack *PyBoolNet-2.2.7.tar.gz* into a temporary folder and run::
...
Install |software| with *pip*::
   ...
   $ sudo pip3 install PyBoolNet-2.2.7_mac64.tar.gz
...
To install |software| with *pip*::
   ...
   C:\> pip.exe install PyBoolNet-2.2.7_win64.tar.gz
