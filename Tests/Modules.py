...
class TestAttractorDetection(unittest.TestCase):
    ...
    def test_find_attractor_by_randomwalk_and_ctl(self):
        ...
        attempts = 10
        update = "asynchronous"
        PyBoolNet.AttractorDetection.find_attractor_by_randomwalk_and_ctl( primes, update, subspace, lengthrandomwalk, attempts )
        update = "synchronous"
        PyBoolNet.AttractorDetection.find_attractor_by_randomwalk_and_ctl( primes, update, subspace, lengthrandomwalk, attempts )
        update = "mixed"
        PyBoolNet.AttractorDetection.find_attractor_by_randomwalk_and_ctl( primes, update, subspace, lengthrandomwalk, attempts )
    ...
    def test_univocal(self):
        ...
        trapspace = {"v4":1}
        answer, state1, state2 = PyBoolNet.AttractorDetection.univocal( primes, "asynchronous", trapspace )
        expected = False
        msg = "\nexpected: "+str(expected)
        msg+= "\ngot:      "+str(answer)
        self.assertTrue(answer==expected, msg)
        ...
        trapspace = {}
        answer = PyBoolNet.AttractorDetection.univocal( primes, "asynchronous", trapspace )
    ...
    def test_faithful(self):
        ...
        # not faithful
        trapspace = {}
        answer, state = PyBoolNet.AttractorDetection.faithful( primes, "asynchronous", trapspace )
        expected = False
        msg = "\nexpected: "+str(expected)
        msg+= "\ngot:      "+str(answer)
        self.assertTrue(answer==expected, msg)
    ...
    def test_completeness_iterative(self):
        ...
        # not complete
        expected  = False
        answer, counterex = PyBoolNet.AttractorDetection.completeness_iterative( primes, "asynchronous" )
        msg = "\nexpected: "+str(expected)
        msg+= "\ngot:      "+str(answer)
        self.assertTrue(answer==expected, msg)
        ...
        # complete
        expected = True
        answer, counterex = PyBoolNet.AttractorDetection.completeness_iterative( primes, "synchronous" )
        msg = "\nexpected: "+str(expected)
        msg+= "\ngot:      "+str(answer)
        self.assertTrue(answer==expected, msg)
...
class TestTemporalQueries(unittest.TestCase):
    def test_EF_subspaces(self):
        ...
        query = PyBoolNet.TemporalQueries.EF_oneof_subspaces(names, subspaces)
        msg = "\nexpected: "+str(expected)
        msg+= "\ngot:      "+str(query)
    ...
    def EF_unsteady(self):
        ...
        query = PyBoolNet.TemporalQueries.EF_unsteady_states(names)
        msg = "\nexpected: "+str(expected)
        msg+= "\ngot:      "+str(query)
        self.assertTrue(query==expected, msg)
    ...
    def test_AGEF_subspaces(self):
        ...
        query = PyBoolNet.TemporalQueries.AGEF_oneof_subspaces(names, subspaces)
        msg = "\nexpected: "+str(expected)
        msg+= "\ngot:      "+str(query)
        self.assertTrue(query==expected, msg)
