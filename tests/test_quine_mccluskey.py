...
def test_functions2mindnf():
    ...
    assert PyBoolNet.boolean_normal_forms.functions2mindnf(functions) == {"v1": "!v2 | v1", "v2": "!v1", "v3": "0", "v4": "1"}


def test_primes2mindnf():
    primes = {"A": [[{}], []], "B": [[], [{}]], "C": [[{"A": 1}, {"B": 0}], [{"A": 0, "B": 1}]]}

    assert PyBoolNet.boolean_normal_forms.primes2mindnf(primes) == {"A": "0", "C": "B&!A", "B": "1"}
